...
public class TunerConstants {
	...
	private static final Slot0Configs steerGains = new Slot0Configs().withKP(60).withKI(1).withKD(0).withKS(-0.1)
			.withKV(0).withKA(0).withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
	// When using closed-loop control, the drive motor uses the control
	// output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
	private static final Slot0Configs driveGains = new Slot0Configs().withKP(60).withKI(1).withKD(1).withKS(-0.1)
			.withKV(0.124);
	...
	private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration().withCurrentLimits(
			new CurrentLimitsConfigs().withStatorCurrentLimit(Amps.of(100)).withStatorCurrentLimitEnable(true));
	...
	private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.28515625);
	...
	private static final Angle kBackRightEncoderOffset = Rotations.of(-0.481716796875);
